...
[视频教程](https://www.bilibili.com/video/BV1LC4y1o7L6/#reply188159845568)   
~~视频中projection::UtmProjector projector(Origin({37.528444, 122.0780557}));是当时建立地图时GPS获取的初始坐标。如果你需要用自己的地图做全局定位，记得在params.yaml文件中将initial_GPS_lat/lon改成你自己的GPS经纬度~~不再需要手动添加经纬度信息了。
# Install
System Require:\
